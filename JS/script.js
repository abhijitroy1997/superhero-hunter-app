...
async function searchHeros(textSearched) {
     ...
     await fetch(`https://gateway.marvel.com/v1/public/characters?ts=1&nameStartsWith=${textSearched}&apikey=1783146bf07aebe454dbbd573615d8a3&hash=8bbda1c385b2a5590c1216a3546e7a5d`)
